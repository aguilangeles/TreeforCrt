...
/**
 * A class representing a node in a meta-data tree, which implements the <a
 * HREF="../../../../api/org/w3c/dom/NamedNodeMap.html">
 *
 * @version 1.0
 */
public class NamedNodeMapImpl implements NamedNodeMap {
  ...
  /**
   * Constructs new
   * <code>NamedNodeMapImpl</code> with the given list of nodes.
   *
  ...
  /**
   * Returns the
   * <code>Node</code> with the given name.
   *
  ...
  /**
   * Returns the
   * <code>Node</code> with the given index.
   *
  ...
  /**
   * Modification of the items is not allowed ! Removes the item with the given
   * name.
   *
  ...
  /**
   * Modification of the items is not allowed ! Sets the item with the given
   * name.
   *
  ...
  /**
   * Equivalent to
   * <code>getNamedItem(localName)</code>.
   */
  ...
  /**
   * Equivalent to
   * <code>removeNamedItem(localName)</code>.
   */
